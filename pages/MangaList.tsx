...
const STORAGE_KEY = 'dandadan_read_chapters';
      ...
      <div className="relative bg-[#111] border-b border-white/5 py-16 px-4 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto relative z-10 text-center">
          ...
          <h1 className="text-4xl md:text-6xl font-heading font-bold text-white mb-6">
            DANDADAN <span className="text-transparent bg-clip-text bg-gradient-to-r from-white to-gray-500">MANGA Library</span>
          </h1>
          <p className="text-gray-400 max-w-2xl mx-auto text-lg font-light">
            Read every chapter of the Dandadan Manga by Tatsu Yukinobu. From the very beginning to the latest release.
          </p>
        </div>
      </div>
      ...
      <div className="bg-white dark:bg-[#0f0f0f] border-b border-gray-100 dark:border-white/5 py-10 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-gray-600 dark:text-gray-400 text-sm leading-relaxed mb-4">
            Momo Ayase believes in ghosts but not aliens. Ken Takakura believes in aliens but not ghosts. When they end up cursed and abducted, their unlikely partnership sparks a chaotic adventure through supernatural phenomena, extraterrestrial encounters, and an unexpected romance.
          </p>
          <div className="flex flex-wrap gap-6 text-xs text-gray-500 dark:text-gray-500">
            <span><strong className="text-gray-700 dark:text-gray-300">Author:</strong> Tatsu Yukinobu</span>
            <span><strong className="text-gray-700 dark:text-gray-300">Publisher:</strong> Shueisha / Shōnen Jump+</span>
            <span><strong className="text-gray-700 dark:text-gray-300">Status:</strong> Ongoing</span>
            <span><strong className="text-gray-700 dark:text-gray-300">Started:</strong> April 2021</span>
          </div>
        </div>
      </div>
